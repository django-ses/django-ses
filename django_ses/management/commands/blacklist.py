...
def _add_options(target):
    return (
        target("-a", "--add", dest="email_to_add", default=False, help="Adds an email to your blacklist"),
        target("-d", "--delete", dest="email_to_delete", default=False, help="Removes an email from your blacklist"),
        target(
            "-l",
            "--list",
            dest="list_emails",
        ...
        target("-s", "--search", dest="search_email", default=False, help="Search for blacklisted emails"),
        target("--page", dest="page", default=1, type=int, help="Page in the results. Starts at 1."),
        target(
            "--limit",
            dest="limit",
            default=1000,
    ...
    def handle(
        ...
        **options,
        ...
        if email_to_add:
            ...
            objs = models.BlacklistedEmail.objects.filter(email__icontains=search_email).order_by("pk")
