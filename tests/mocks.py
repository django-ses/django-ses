...
def get_mock_received_email():
    return {
        ...
        "headers": [
            {"name": "Return-Path", "value": "<alexandernst@gmail.com>"},
            {
                "name": "Received",
            ...
            {"name": "From", "value": '"Alexander Nestorov (alexandernst)" <alexandernst@gmail.com>'},
            {"name": "Date", "value": "Sun, 27 Oct 2024 18:12:55 +0100"},
            {"name": "Message-ID", "value": "<CACuz9s0EbFBFEdgJN6Pfc74mQ6+-S36UEZXO1=pbabnGx5ObOw@mail.gmail.com>"},
            {"name": "Subject", "value": "test"},
            {"name": "To", "value": "foo@bar.com"},
            {"name": "Content-Type", "value": 'multipart/alternative; boundary="000000000000b6d36a0625787884"'},
        ],
        "commonHeaders": {
            "returnPath": "alexandernst@gmail.com",
            "from": ['"Alexander Nestorov (alexandernst)" <alexandernst@gmail.com>'],
