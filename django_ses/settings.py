...
# Blacklists
AWS_SES_ENABLE_BOUNCE_BLACKLIST = getattr(settings, 'AWS_SES_ENABLE_BOUNCE_BLACKLIST', False)
AWS_SES_ENABLE_COMPLAINT_BLACKLIST = getattr(settings, 'AWS_SES_ENABLE_COMPLAINT_BLACKLIST', False)
